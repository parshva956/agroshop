...
$id=$_GET['id'];
$query="SELECT * FROM `buyer` WHERE `b_id`=$id";
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="#" class="nav_logo"  style=" text-decoration: none"> <i class='bx bx-layer nav_logo-icon'></i>
                ...
                <div class="nav_list">
                    <a style=" text-decoration: none" href="dashboard.php" class="nav_link"> <i
                            class='bx bx-grid-alt nav_icon'></i>
                        <span class="nav_name">Dashboard</span> </a> 
                        <a href="manage_buyers.php" class="nav_link"  style=" text-decoration: none"> <i
                            class='bx bx-user nav_icon'></i> <span class="nav_name active">Buyers</span> </a>
            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form class="requires-validation" action="_update-buyers.php?id=<?php echo $id ?>" novalidate method="post">
