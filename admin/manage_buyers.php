...
while(($row= mysqli_fetch_assoc($result))){
    ...
    <th>Buyer</th>
    <th>'.$row['is_active'].'</th>
    <th><a href = "update_buyers.php?id='.$row['b_id'].'" class="btn btn-primary">Update</a></th>
    <th><a href = "remove_buyer.php?id='.$row['b_id'].'" class="btn btn-danger">Remove</a></th>
    </tr>
    '; 
$count++;
