                    ...
                    <div class="form-items">
                        ...
                        <form class="requires-validation"  enctype="multipart/form-data"  method="POST">
                            ...
                            <div class="col-md-12">
                                ...
                                <input  placeholder="Product name" type="text" name="p_name" >
...
$query = "INSERT INTO `product_master`(`p_id`,`s_id`, `cat_id`, `p_name`, `p_info`, `price`, `image`, `status`) VALUES ('','".$sell_id."','".$_POST['category']."','".$_POST['p_name']."','".$_POST['description']."','".$_POST['price']."','$filename','1')";
